class User < ActiveRecord::Base
  ...
  # Setup accessible (or protected) attributes for your model
  attr_accessible :email, :password, :password_confirmation, :remember_me, :name, :address_1, :birth_date, :phone_no_1, :address_2,:street, :area, :emergency_name,:emergency_no,:city,:district,:state,:pic
  #attr_reader :name
  ...
  validates_numericality_of :phone_no_1, :phone_no_2, :emergency_no
